<!-- AUDIO -->
<!-- <section class="audio bg-zinc-800 fixed bottom-5 left-1/2 transform -translate-x-1/2 text-center p-2 text-white shadow-2xl rounded-lg hidden z-50"> -->
<section class="audio bg-zinc-800 fixed bottom-0 w-full text-center p-2 text-white shadow-2xl hidden z-50">
